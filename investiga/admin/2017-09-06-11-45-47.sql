...
CREATE TABLE `miembrosProyectos` (
  ...
  `tipo` enum('principal','colaborador') COLLATE utf8_spanish_ci DEFAULT NULL
...
-- Dump completed on 2017-09-06 11:45:47
